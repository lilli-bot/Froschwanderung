...
{# After X minutes of idle time between the rows, we assume that a new user has entered #}
  CASE WHEN 
    date_sub('minute', 
...
{# If more than X hours have passed between new evens, we assume that a new session has begun #}
  CASE WHEN 
    date_sub('hour', 
